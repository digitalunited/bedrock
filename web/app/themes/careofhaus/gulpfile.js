...
gulp.task('icomoon', function () {
  ...
  gulp.src(path.source + 'fonts/icomoon/style.css')
      .pipe(replace('fonts/icomoon', 'icomoon'))
      .pipe(gulp.dest(path.source + 'fonts/icomoon'));
});
...
gulp.task('watch', function () {
  ...
  browserSync.init({
    files: ['{lib,templates,components}/**/*.php', '*.php'],
    proxy: config.devUrl,
    open: true,
    notify: true,
    snippetOptions: {
...
gulp.task('build', function (callback) {
  runSequence(
      ['fonts', 'images', 'components-styles'],
      'wiredep',
      'icomoon',
      'components-assets',
      'styles',
...
gulp.task('wiredep', ['components-styles'], function () {
