...
wp plugin activate soil advanced-custom-fields-pro cms-tree-page-view disable-comments filenames-to-latin post-duplicator vc-clean-up wordpress-clean-up js_composer
